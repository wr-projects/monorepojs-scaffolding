...
1.  **[Project activity](#project-activity)**: **7.43** (weight is 0.5)
...
Score: **7.43**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

46 commits in the last 3 months results to 7.08 points
2 contributors increase the score value from 7.08 to 7.43
